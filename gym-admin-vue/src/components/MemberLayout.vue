<template>
  <el-container style="height: 100vh;">
    <el-aside :width="asideWidth + 'px'" class="no-aside-padding">
      <Sidebar ref="sidebarRef" role="member" />
    </el-aside>
    <el-container>
...
const username = ref(localStorage.getItem('username') || '会员')
...
.logo-text { color:white;font-weight:700 }

.groups { padding: 12px }
.group { margin-bottom: 10px }
.group-title { font-size:12px;color:#aab4c8;padding:8px 6px;font-weight:700 }
.group-list { list-style:none;padding:6px;margin:0 }
.group-item { display:flex;align-items:center;gap:10px;padding:10px;border-radius:8px;color:#dbeafe;cursor:pointer;transition:all .18s }
.group-item .icon { width:20px;height:20px }
.group-item:hover { transform: translateX(6px); background: linear-gradient(90deg, rgba(139,92,246,0.06), rgba(6,182,212,0.03)); box-shadow:0 8px 24px rgba(99,102,241,0.06) }
.group-item.active { background: linear-gradient(90deg,#7c5cf633,#4f46e533); box-shadow: 0 10px 30px rgba(99,102,241,0.08); border-left:3px solid #8B5CF6 }
